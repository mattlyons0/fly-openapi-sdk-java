...
public class EncryptSecretkeyResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link EncryptSecretkeyResponse} and sets the default values.
     */
    public EncryptSecretkeyResponse() {
    ...
    public static EncryptSecretkeyResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new EncryptSecretkeyResponse();
    }
    /**
