...
public class AppSecret implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link AppSecret} and sets the default values.
     */
    public AppSecret() {
    ...
    public static AppSecret createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
