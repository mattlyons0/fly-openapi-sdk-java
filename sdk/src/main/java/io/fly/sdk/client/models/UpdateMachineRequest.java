...
public class UpdateMachineRequest implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link UpdateMachineRequest} and sets the default values.
     */
     ...
     * @return a {@link UpdateMachineRequest}
     */
    @jakarta.annotation.Nonnull
    public static UpdateMachineRequest createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    /**
     * Gets the current_version property value. The current_version property
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("current_version", (n) -> { this.setCurrentVersion(n.getStringValue()); });
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("current_version", this.getCurrentVersion());
    ...
    /**
     * Sets the current_version property value. The current_version property
