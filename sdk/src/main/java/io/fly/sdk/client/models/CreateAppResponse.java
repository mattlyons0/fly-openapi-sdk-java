...
public class CreateAppResponse implements AdditionalDataHolder, Parsable {
    /**
    ...
    /**
     * Instantiates a new {@link CreateAppResponse} and sets the default values.
     */
    ...
    public static CreateAppResponse createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
